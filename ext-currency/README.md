...
```
node build --copy; site/vendor/bin/phpunit site/tests/unit/Espo/Modules/Currency
```
...
```
(cd site && vendor/bin/phpunit tests/integration/Espo/Modules/Currency)
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/Currency`
* `site/tests/integration/Espo/Modules/Currency`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/Currency/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/Currency/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/currency/lib/init.js"
        ]
    }
    ```
