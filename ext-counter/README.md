...
```
node build --copy; site/vendor/bin/phpunit site/tests/unit/Espo/Modules/Counter
```
...
```
(cd site && vendor/bin/phpunit tests/integration/Espo/Modules/Counter)
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/Counter`
* `site/tests/integration/Espo/Modules/Counter`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/Counter/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/Counter/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/counter/lib/init.js"
        ]
    }
    ```
